  ...
  return (
    <div className="p-6 space-y-5 text-white max-w-2xl">
      <div className="flex items-center gap-3">
        <Bot className="w-5 h-5 text-[#0EB8FF]" />
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <button onClick={generateGreeting} disabled={!bizName || generating}
              className="flex items-center gap-1 text-xs text-[#0EB8FF] hover:text-white disabled:opacity-40 transition-all">
          ...
          <div className="space-y-2">
            {calls.map((c, i) => (
              <div key={i} className="flex items-start gap-3 p-3 bg-white/3 rounded-lg">
                <Bot className="w-4 h-4 text-[#0EB8FF] mt-0.5 flex-shrink-0" />
